...
int main(int argv, char* argc[]) {
    ...
    std::vector<int> wins_2(4,0);
    std::vector<int> wins_3(4,0);
    std::vector<int> wins_4(4,0);
    ...
    for(int i = 0; i < atoi(argc[5])*4; ++i) {
        ...
        //Parent waits
            ...
            for (int j = 0; j < 4; ++j) res.push(score[j]);
            ...
            maxPoints=std::max(temp,maxPoints);
            ++wins[(i+k)%4];
            ...
            std::cout << std::endl;
            for(int j = 0; j < 4; ++j) {
                int percentage=(wins_2[j]/double(i+1))*100;
                std::cout << argc[j+1] << " wins_2 " << wins_2[j] << " times" << std::endl;
                std::cout << "[";
                for(int l = 0; l < percentage; ++l)
                    std::cout << "#";
                for(int l = 0; l < 100-percentage; ++l)
            ...
            std::cout << std::endl;
            for(int j = 0; j < 4; ++j) {
                int percentage=(wins_3[j]/double(i+1))*100;
                std::cout << argc[j+1] << " wins_3 " << wins_3[j] << " times" << std::endl;
                std::cout << "[";
                for(int l = 0; l < percentage; ++l)
                    std::cout << "#";
                for(int l = 0; l < 100-percentage; ++l)
            ...
            std::cout << std::endl;
            for(int j = 0; j < 4; ++j) {
                int percentage=(wins_4[j]/double(i+1))*100;
                std::cout << argc[j+1] << " wins_4 " << wins_4[j] << " times" << std::endl;
                std::cout << "[";
                for(int l = 0; l < percentage; ++l)
                    std::cout << "#";
                for(int l = 0; l < 100-percentage; ++l)
    ...
    std::cout << std::endl;
    for(int j = 0; j < 4; ++j) {
        int percentage=wins_2[j]/double(atoi(argc[5])*4)*100;
        std::cout << argc[j+1] << " wins_2 " << wins_2[j] << " times" << std::endl;
        std::cout << "[";
        for(int l = 0; l < percentage; ++l)
            std::cout << "#";
    ...
    std::cout << std::endl;
    for(int j = 0; j < 4; ++j) {
        int percentage=wins_3[j]/double(atoi(argc[5])*4)*100;
        std::cout << argc[j+1] << " wins_3 " << wins_3[j] << " times" << std::endl;
        std::cout << "[";
        for(int l = 0; l < percentage; ++l)
            std::cout << "#";
    ...
    std::cout << std::endl;
    for(int j = 0; j < 4; ++j) {
        int percentage=wins_4[j]/double(atoi(argc[5])*4)*100;
        std::cout << argc[j+1] << " wins_4 " << wins_4[j] << " times" << std::endl;
        std::cout << "[";
        for(int l = 0; l < percentage; ++l)
            std::cout << "#";
