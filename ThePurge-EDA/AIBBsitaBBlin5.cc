 ...
 */
#define PLAYER_NAME BBsitaBBlin5
                ...
                if (max_num_barricades() > int(barricades(me()).size())) {
                    ...
                    if (move_to.first != p) go_for_it(id, p, move_to.first);
                        ...
                        if (not build_random_barricade(id, p)) {
                            move_to = search_for_items(p, NoBonus, NoWeapon, true, 20);
                    ...
                    if (move_to.first != p) {
                        ...
                        if(need_health) {
                            ...
                            if (move_to.first != p) {
                                ...
                                move_to = search_for_items(p, Money, NoWeapon, true, 20);
                                if (move_to.first != p) go_for_it(id, p, move_to.first);
                            }
                        }else{
                            move_to = search_for_items(p, NoBonus, NoWeapon, true, 15);
                            if (move_to.first != p) {
                                go_for_it(id, p, move_to.first);
                            }
                        }
        ...
        for (int id : w) {
            ...
            if (has_bazooka) {
                if (need_health) move_to = search_for_items(p, Food, NoWeapon, true, 27);
                    ...
                    if (is_day())move_to2 = search_for_items(p, NoBonus, Bazooka, true, 10);
